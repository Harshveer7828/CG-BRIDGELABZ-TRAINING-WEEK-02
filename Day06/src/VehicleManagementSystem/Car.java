...
public class Car extends Vehicle implements Insurable {
    ...
    // Getting car details
    Car(int vehicleNumber, String type, double rate, double insuranceRate, String insurancePolicyNumber) {
    ...
    public String getInsuranceDetails() {
        return "Car Insurance policy number is " + insurancePolicyNumber;
    }
