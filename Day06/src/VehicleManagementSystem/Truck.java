...
public class Truck extends Vehicle implements Insurable{
    ...
    Truck(int vehicleNumber, String type, double rate, double insuranceRate, String insurancePolicyNumber){
    ...
    public String getInsuranceDetails() {
        return "Truck Insurance policy number is " + insurancePolicyNumber;
    }
}
